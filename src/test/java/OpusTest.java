...
public class OpusTest {
    ...
    public static void main(String[] args) throws LineUnavailableException {
        new OpusTest().testCodec();
    }

    public void testCodec() throws LineUnavailableException {

        AudioFormat format = new AudioFormat(16000f, 16, 1, true, true);
    ...
    private ShortBuffer decode(List<ByteBuffer> packets) {
        ...
        PointerByReference opusDecoder = Opus.INSTANCE.opus_decoder_create(16000, 1, error);
    ...
    private List<ByteBuffer> encode(ShortBuffer shortBuffer) {
        IntBuffer error = IntBuffer.allocate(4);
        PointerByReference opusEncoder = Opus.INSTANCE.opus_encoder_create(16000, 1,
