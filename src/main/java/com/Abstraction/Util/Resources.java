...
public class Resources {
    ...
    public static URL getMainIcon() {
        return Resources.class.getResource(instance.properties.getProperty("MainIcon"));
    }

    public static URL getOnlineIcon() {
        return Resources.class.getResource(instance.properties.getProperty("OnlineIcon"));
    }

    public static URL getOfflineIcon() {
        return Resources.class.getResource(instance.properties.getProperty("OfflineIcon"));
    }

    public static URL getConversationIcon() {
        return Resources.class.getResource(instance.properties.getProperty("ConversationIcon"));
    }
