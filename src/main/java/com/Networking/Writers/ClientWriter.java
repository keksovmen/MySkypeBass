...
public class ClientWriter extends BaseWriter {
    ...
    public void writeAcceptCall(int from, int to) throws IOException {
    ...
    public void writeDenyCall(int from, int to) throws IOException {
    ...
    public void writeCancelCall(int from, int to) throws IOException {
    ...
    public void writeDisconnectFromConversation(int from) throws IOException {
