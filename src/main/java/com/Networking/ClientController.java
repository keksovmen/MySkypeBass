...
//
//    @Override
//    public boolean attach(ActionsHandler listener) {
//        return handlerList.add(listener);
//    }
//
//    @Override
//    public boolean detach(ActionsHandler listener) {
...
//
//    /**
//     * Helps handleRequest all shit that comes from UI
//     */
//
//    private class ClientResponder implements ActionableLogic {
//
//        private SimpleServer server; // made final
//
...
//            try {
//                server = SimpleServer.getFromStrings(port, sampleRate, sampleSize);
//            } catch (IOException e) {
...
//                return;
//            }
//            boolean start = this.server.start("SimpleServer");
//            if (start) {
